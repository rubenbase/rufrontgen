...
import { UpdateCategoryMutation, UpdateCategoryMutationVariables } from "../../../schemaTypes";
export declare const updateCategoryMutation: any;
export interface WithUpdateCategory {
    updateCategory: MutationFn<UpdateCategoryMutation, UpdateCategoryMutationVariables>;
}
