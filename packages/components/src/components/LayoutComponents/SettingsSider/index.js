  ...
  render() {
    ...
    return (
      <div
        className={
          "settingsSider " +
          (layoutState.settingsOpened ? "settingsSider--opened" : "")
        }
      >
        <Scrollbars style={{ height: "100vh" }}>
          <div className="settingsSider__container">
            ...
            <div className="settingsSider__description">
              This component "SettingsSider" gives possibility to construct
              custom blocks with any widgets, components and elements inside,
              like this theme settings
            </div>
            <div className="settingsSider__item">
              <Switch
                checked={layoutState.isMenuTop}
                onChange={this.setIsMenuTop}
              />
              <span className="settingsSider__itemLabel">
                Menu Top (Horizontal)
              </span>
            </div>
            <div className="settingsSider__item">
            ...
            <div className="settingsSider__item">
              <Switch
                checked={layoutState.menuShadow}
                onChange={this.setMenuShadow}
              />
              <span className="settingsSider__itemLabel">Menu Shadow</span>
            </div>
            <div className="settingsSider__item">
              <Switch
                checked={layoutState.themeLight}
            ...
            <div className="settingsSider__item">
              <Switch
                checked={layoutState.borderLess}
                onChange={this.setBorderLess}
              />
            ...
            <div className="settingsSider__item">
              <Switch
                checked={layoutState.fixedWidth}
                onChange={this.setFixedWidth}
              />
